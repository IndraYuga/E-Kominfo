        ...
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    <h1 class="display-3 text-white animated slideInDown">Pelatihan</h1>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="course-item bg-light h-100">
                        ...
                        <div class="text-center p-4">
                            ...
                            <small class="text-center">
                                <i class="fa fa-map text-dark me-1"></i>
                                <span style="border-right: 1px solid #000; padding-right: 5px;"><?php echo $row['lokasi']; ?></span>
                            </small>
                            </div>
                        </div>
                    </div>
