...
if (isset($_POST['submit'])) {
  ...
  if ($_FILES['foto']['name'] != "") {
    ...
    if (move_uploaded_file($fotoTmp, $targetFile)) {
      ...
      $sql = "UPDATE tb_user SET foto='$fotoName', nama='$nama', nama_lengkap='$namaLengkap',  kelamin='$kelamin', alamat='$alamat', email='$email' WHERE id_user = $id_user";
    ...
    $sql = "UPDATE tb_user SET nama='$nama', nama_lengkap='$namaLengkap', kelamin='$kelamin', alamat='$alamat', email='$email'  WHERE id_user = $id_user";
